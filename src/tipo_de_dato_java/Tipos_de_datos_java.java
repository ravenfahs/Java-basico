...
Crea un proyecto de Java desde 0 Dentro del proyecto tenéis que crear un paquete. En el paquete tendréis que generar una clase.
Dentro de la clase tenéis que generar el método main e imprimir todos los datos que se han visto en las sesiones.
